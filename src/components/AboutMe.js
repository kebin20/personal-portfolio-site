    ...
    <section id="about" className="about">
      <div className="main-container">
        ...
        <h3 className="main-container__main-title">
          Here you will find information about me and a list of
          ...
          <div className="info">
            <div className="info__main-info">
              ...
              <p className="info__main-info__text-primary">
                <span>
                I&apos;m a highly motivated junior web developer with a year of experience in creating visually stunning and functionally impressive websites. I&apos;m passionate about blending design and functionality to deliver a user-friendly experience that exceeds client expectations. I have the skills to create responsive layouts that look great on any device, and I&apos;m committed to translating your ideas into an engaging online presence. Let&apos;s work together to bring your website dreams to life.
                </span>
